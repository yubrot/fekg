...
export function useMouse({ onDrag, onMove, onWheel }: MouseOptions): Mouse {
...
function useMouseDrag(container: HTMLElement | null, onDrag: MouseOptions['onDrag']): void {
...
function useMouseMove(container: HTMLElement | null, onMove: MouseOptions['onMove']): void {
...
function useMouseWheel(container: HTMLElement | null, onWheel: MouseOptions['onWheel']): void {
